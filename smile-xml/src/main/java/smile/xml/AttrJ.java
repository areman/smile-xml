...
public class AttrJ extends NodeJ
{
  ...
  public static RubyClass define(Ruby runtime)
  {
    ...
    RubyClass result = module.defineClassUnder("Attr", runtime.getObject(), ALLOCATOR);
    result.defineAnnotatedMethods(AttrJ.class);
    return result;
  }

  public static RubyClass getRubyClass(Ruby runtime) {
    return UtilJ.getClass(runtime, new String[] { "LibXML", "XML", "Attr" });
  }

  public static AttrJ newInstance(ThreadContext context) {
    return (AttrJ)getRubyClass(context.getRuntime()).newInstance(context, new IRubyObject[0], null);
  }
  ...
  public void initialize(ThreadContext context, IRubyObject[] args) {
    ...
    RubyString name = (RubyString)(RubyString)(args.length > 1 ? args[1] : null);
    RubyString value = (RubyString)(RubyString)(args.length > 2 ? args[2] : null);
